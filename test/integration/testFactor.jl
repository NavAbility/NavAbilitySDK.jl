...
function runFactorTests(client, context)
    @testset "factor-testset" begin
        ...
        @testset "Listing" begin
            testLsf(client, context, factorLabels, factorTypes)
        end
        @testset "Getting" begin
            testGetFactor(client, context, factorLabels, factorTypes)
        end
        @testset "Getting Lists" begin
            testGetFactors(client, context, factorLabels, factorTypes)
        end
        @testset "Delete" begin
            testDeleteFactor(client, context, factorLabels)
        end
    end
end
